...
See [ci-cd-pipelines.md](./ci-cd-pipelines.md) for the full vision: hybrid compute, `.opengitbase-ci.yml` v1, Kafka event bus, Firecracker + OverlayFS, Layer Store, and admin promotion workflow.
