...
namespace OpenGitBase.Common.Migrations
{
    ...
    [Migration("20260814094806_AddStatusOutageWindowUniqueActiveKey")]
    partial class AddStatusOutageWindowUniqueActiveKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenGitBase.Features.ComputeNode.Entities.ComputeNodeEntity", b =>
                {
                    ...
                    b.Property<string>("IdentityTokenHash")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("OpenGitBase.Features.Pipeline.Entities.DependencyPromotionRequestEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("LayerStoreObjectKey")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)");
                    ...
                    b.ToTable("DependencyPromotionRequest", (string)null);
                });

            modelBuilder.Entity("OpenGitBase.Features.Pipeline.Entities.DomainAllowanceRequestEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Scope", "OrganizationId", "Status");

                    b.ToTable("DomainAllowanceRequest", (string)null);
                });

            modelBuilder.Entity("OpenGitBase.Features.Pipeline.Entities.GitPushOutboxEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("GitPushOutbox", (string)null);
                });
            ...
            modelBuilder.Entity("OpenGitBase.Features.Pipeline.Entities.OrgEgressAllowlistEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("OrgEgressAllowlist", (string)null);
                });
            ...
            modelBuilder.Entity("OpenGitBase.Features.Pipeline.Entities.PlatformEgressAllowlistEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PlatformEgressAllowlist", (string)null);
                });
            ...
            modelBuilder.Entity("OpenGitBase.Features.Status.Entities.StatusOutageWindowEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTimeOffset?>("BecamePublicAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTimeOffset?>("LastNonUnhealthyAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTimeOffset>("UnhealthySince")
                        .HasColumnType("timestamp with time zone");
